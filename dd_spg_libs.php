...
Filename: dd_spg_libs.php
Uses: This file will load for plugins front-end and backend, It has some global functions, So all function here can access from anywhere of this plugins.
*/
...
* @access public
*/
define('PLUGINS_WEBSITE', 'http://www.dropndot.com/blog/dd-simple-photo-gallery-wordpress-plugin/');
